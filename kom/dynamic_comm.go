...
func (k8s *Kom) ConvertUnstructuredToTypedObject(obj *unstructured.Unstructured, objType runtime.Object) error {
...
func (k8s *Kom) ConvertToUnstructured(obj interface{}) (*unstructured.Unstructured, error) {
...
func (k8s *Kom) ConvertUnstructuredToYAML(obj *unstructured.Unstructured) (string, error) {
